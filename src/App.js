...
function App() {
   let userID = Date.now();
   let backendUrl = "http://shikib.sp.cs.cmu.edu:8888/"
   //let backendUrl = "http://c6c9d765.ngrok.io";
   let dataBackendUrl = "http://dialog.speech.cs.cmu.edu:8000/data";
          ...
          <Row className="justify-content-md-center">
            ...
            <Col xs lg="4" className="InstructionHolder">
              <div className="Instructions">
                ...
                <img src="https://skylar.speech.cs.cmu.edu/web/master/images/NSF.png" className="Logo" /> 
                <img src="https://skylar.speech.cs.cmu.edu/web/master/images/lti-notext.png" className="Logo" /> 
                <img src="https://skylar.speech.cs.cmu.edu/web/master/images/USC.png" className="Logo" /> 
              </div>
            </Col>
          </Row>
        </Container>
